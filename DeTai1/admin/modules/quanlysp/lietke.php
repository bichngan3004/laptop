...
<body>
	<?php
		$sql_lietke_sp= "select * from tbl_sanpham,tbl_danhmuc,tbl_hang where tbl_sanpham.id_danhmuc=tbl_danhmuc.id_danhmuc=tbl_hang.id_hang order by id_sanpham desc ";
